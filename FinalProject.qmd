...
```
For our first attempt at a machine learning model we used the debt-to-income ratio dataset to predict percent minority census tracts. While tuning was used to refine the parameters of the lasso model, the RMSE was still 22
