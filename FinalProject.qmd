...
debt_to_income$NAME <- debt_to_income$NAME / 100

debt_to_income$NAME <- as.character(debt_to_income$NAME)

debt_tract <- full_join(debt_to_income, DMV_tracts, by = "NAME")
